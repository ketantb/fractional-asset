    ...
    <div className='property-details-wrapper'>
      ...
      <FormControl className='form-field'>
        <TextField type='number' id="standard-basic" label="Total shares" variant="standard"
          name='totalShare' value={propertyData.totalShare} onChange={handleInputs} />
      </FormControl>
      <FormControl className='form-field'>
        <TextField type='number' id="standard-basic" label="Available Shares" variant="standard"
          name='availableShare' value={propertyData.availableShare} onChange={handleInputs} />
      </FormControl>
      <FormControl className='form-field'>
        <TextField id="standard-basic" label="Price Per Share" variant="standard"
          name='pricePerShare' value={propertyData.pricePerShare} onChange={handleInputs} />
      </FormControl>
